...
class ModelTrainer:
    ...
    def initate_model_training(self,train_array,test_array):
        try:
            ...
            logging.info('Exception occured at Model Exaluation')
...
#from src.components.data_transformation import initaite_data_transformation
...
class ModelTrainer:
    ...
    def initate_model_training():
        try:
            ...
            logging.info("Error in the model evalutaion")
            raise CustomException(e,sys)                        '''